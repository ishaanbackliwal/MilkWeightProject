 ...
 * 
 * Output stage of the GUI Prompts user for different forms of output and then
 * produces those desired outputs
 * 
...
public class OutputStage extends Stage {
	...
	private boolean inProgress = false; // tells if an output option is in
																			// progress
